-- PRODUCTION CANDIDATE: NOT EXECUTED REMOTELY. Operational production bnceclhjhgjfirubudwi only.
-- Derived from the staging migration executed on 10/09/2026. Audit the live production schema before execution.
BEGIN;
