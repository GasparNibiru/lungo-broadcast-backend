...
async function sendAccessEmail({ email, name, organizationName, planName, token, paymentUrl }) {
  ...
  const payload = { fromAddress: fromEmail, toAddress: email, subject: 'Seu acesso à plataforma Lungo Corretores', content: emailHtml({ name, organizationName, planName, token, accessUrl, paymentUrl }), mailFormat: 'html', encoding: 'UTF-8' };
